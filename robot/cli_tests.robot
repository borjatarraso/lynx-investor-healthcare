*** Settings ***
Documentation    CLI integration tests for lynx-health
Library          Process
...
Given The Application Is Available
    Run App    --version
    Should Contain    ${OUTPUT}    lynx-health
...
Show Help
    ...
    Then The Output Should Contain "lynx-health"
...
Show About
    ...
    When I Run About
    Then The Exit Code Should Be 0
    Then The Output Should Contain "Lynx Healthcare Analysis"
...
Explain A Healthcare-Specific Metric R&D Intensity
    ...
    Given The Application Is Available
    When I Explain Metric "rd_intensity"
    Then The Exit Code Should Be 0
    Then The Output Should Contain "R&D"

Explain A Healthcare-Specific Metric Cash Runway
    [Documentation]    GIVEN the app WHEN I explain cash_runway_years THEN it shows runway info
    Given The Application Is Available
    When I Explain Metric "cash_runway_years"
    Then The Exit Code Should Be 0
    Then The Output Should Contain "Cash Runway"
...
Explain A Section
    ...
    Given The Application Is Available
    When I Explain Section "health_quality"
    Then The Exit Code Should Be 0
    Then The Output Should Contain "Healthcare Quality"
...
Search For A Healthcare Company
    [Documentation]    GIVEN the app WHEN I search for a healthcare company THEN results are shown
    Given The Application Is Available
