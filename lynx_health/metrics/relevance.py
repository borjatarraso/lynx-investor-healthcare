"""Metric relevance by company tier AND healthcare lifecycle stage.

Defines which metrics are CRITICAL, IMPORTANT, RELEVANT, CONTEXTUAL (informational)
or IRRELEVANT for each combination of company size tier and healthcare development stage.
...
Stage axis (healthcare-specific):
...
Example: For a clinical-stage (GROWTH) biotech, cash runway and burn rate are CRITICAL,
P/E is IRRELEVANT, and R&D intensity is IMPORTANT.
"""

from __future__ import annotations

from lynx_health.models import CompanyStage, CompanyTier, Relevance
...
def get_relevance(
    ...
    for healthcare analysis (lifecycle dimension parallels other sector kits).
    """
    ...
    table = {
        ...
        "health_quality": TECH_QUALITY_RELEVANCE,
