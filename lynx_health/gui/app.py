"""Tkinter graphical user interface for Lynx Healthcare Analysis."""
...
from lynx_health.models import AnalysisReport, CompanyStage, CompanyTier, Relevance, Severity
...
class SplashScreen:
    ...
    def __init__(self, root: tk.Tk, on_done: callable) -> None:
        ...
        self.subtitle = tk.Label(
            center, text="Healthcare Analysis", font=FONT_SPLASH_SUB,
            bg=BG, fg=ACCENT,
        )
        ...
        # Version
        from lynx_health import __version__, __year__, __author__, SUITE_LABEL
...
class LynxHealthGUI:
    ...
    def __init__(self, cli_args) -> None:
        ...
        self.root = tk.Tk()
        self.root.title("Lynx Healthcare Analysis")
    ...
    def _after_splash(self) -> None:
        ...
        from lynx_health.tui.themes import HOUSE_THEMES as _HOUSE_THEMES
        ...
        try:
            ...
            pass
        self._theme_cycler = ThemeCycler(self.root, start="health-dark")
    ...
    def _build_toolbar(self) -> None:
        ...
        tk.Label(
            brand, text="Lynx Healthcare", font=(_FAMILY, 14, "bold"),
    ...
    def _show_themes_menu(self) -> None:
        ...
        sector_family = ["health-dark", "health-light", "cybrdots"]
    ...
    def _show_controls(self) -> None:
        ...
        self._show_info_popup(
            ...
            "lynx-health -- Graphical Interface",
            sections,
        )

    def _on_about(self) -> None:
        from lynx_health import get_about_text
        about = get_about_text()

        win = tk.Toplevel(self.root)
        win.title("About lynx-health")
        win.configure(bg=BG)
    ...
    def _ee_shake(self) -> None:
        from lynx_health.easter import tk_fireworks
        tk_fireworks(self.root)

    def _ee_rainbow(self) -> None:
        from lynx_health.easter import tk_rainbow_title
        tk_rainbow_title(self.root)

    def _ee_fortune(self) -> None:
        from lynx_health.easter import FORTUNE_QUOTES
        import random
    ...
    def _run_analysis(self, identifier: str) -> None:
        try:
            ...
            from lynx_health.core.storage import is_testing
            ...
            from lynx_health.core.analyzer import SectorMismatchError
    ...
    def _render_stage(self, stage: str, report: AnalysisReport) -> None:
        ...
        try:
            ...
            elif stage == "health_quality":
                self._render_health_quality(report)
    ...
    def _show_sector_mismatch(self, msg: str) -> None:
        ...
        tk.Label(
            ...
            text=(
                ...
                "Healthcare  |  SaaS  |  Cloud  |  Cybersecurity\n"
    ...
    def _render_profile(self, r: AnalysisReport) -> None:
        ...
        # Healthcare Category display
        category_text = p.health_category.value if hasattr(p.health_category, 'value') else str(p.health_category)
        ...
        rows: list[tuple[str, str, str]] = [
            ...
            ("Stage", stage_text, FG),
            ("Healthcare Category", category_text, YELLOW),
    ...
    def _render_sector_industry(self, r: AnalysisReport) -> None:
        from lynx_health.metrics.sector_insights import get_sector_insight, get_industry_insight
    ...
    def _render_valuation(self, r: AnalysisReport) -> None:
        ...
        from lynx_health.display import (
        ...
        if all_irrelevant:
            ...
            note = tk.Label(
                ...
                text=(f"Profitability metrics are not applicable for {stage_name} stage companies. "
                      f"Preclinical biotech companies have no meaningful margins or returns on capital to evaluate."),
    ...
    def _render_health_quality(self, r: AnalysisReport) -> None:
        m = r.health_quality
        if m is None:
            return
        card = CollapsibleCard(
            self.scroll_frame, "Healthcare Quality Indicators",
            icon=ICON_TECH, accent=YELLOW, expanded=False,
            info_command=lambda: self._show_section_info("health_quality"),
        )
        self._sections.append(card)
        frame = card.frame
        ...
        stage = r.profile.stage
        tier = _get_tier(r)
        rel = lambda key: get_relevance(key, tier, "health_quality", stage)
    ...
    def _render_screening(self, r: AnalysisReport) -> None:
        """Render the 10-point healthcare screening checklist."""
        ...
        card = CollapsibleCard(
            self.scroll_frame, "Healthcare Screening Checklist",
    ...
    def _render_conclusion(self, r: AnalysisReport) -> None:
        ...
        # Category scores (using health_quality instead of moat)
        sep = tk.Frame(frame, bg=BORDER, height=1)
        sep.pack(fill=tk.X, padx=12, pady=6)
        for i, cat in enumerate(("valuation", "profitability", "solvency", "growth", "health_quality")):
    ...
    def _download_filing_gui(self, filing) -> None:
        ...
        def _do():
            from lynx_health.core.reports import download_filing
            try:
    ...
    def _show_metric_info(self, key: str) -> None:
        from lynx_health.metrics.explanations import get_explanation
    ...
    def _show_section_info(self, section_key: str) -> None:
        from lynx_health.metrics.explanations import get_section_explanation
    ...
    def _show_conclusion_info(self, category: str = "overall") -> None:
        from lynx_health.metrics.explanations import get_conclusion_explanation
