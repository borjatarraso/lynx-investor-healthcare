...
Healthcare Category: {esc(_ev(p.health_category))} &nbsp;|&nbsp;
...
""")
    ...
    if report.health_quality:
        ...
        parts.append('<div class="card"><h2>Healthcare Quality Indicators</h2>')
        parts.append(_metric_table([
    ...
    if report.market_intelligence:
        ...
        if mi.benchmark_name or mi.sector_etf_name:
            parts.append("<h2>Healthcare Benchmark &amp; Sector Context</h2>")
            ctx_fields = []
    ...
    if c.screening_checklist:
        parts.append("<h2>Healthcare Screening Checklist</h2>")
    ...
    parts.append(f"""
<div class="footer">
  Lynx Healthcare Analysis &mdash; Lince Investor Suite<br>
