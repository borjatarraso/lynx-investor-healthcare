...
from lynx_health.core.storage import get_reports_dir, save_binary, save_json, save_text
from lynx_health.models import Filing

DOWNLOAD_HEADERS = {"User-Agent": "Mozilla/5.0 (compatible; LynxHealth/0.1)", "Accept-Encoding": "gzip, deflate"}
EDGAR_HEADERS = {"User-Agent": "LynxHealth/0.1 lynx-health-research@example.com", "Accept-Encoding": "gzip, deflate"}
