...
from lynx_health.core.storage import get_financials_dir, save_json
from lynx_health.models import CompanyProfile, FinancialStatement
...
def fetch_financial_statements(ticker: str) -> list[FinancialStatement]:
    ...
    if income is not None and not income.empty:
        for col in income.columns:
            ...
            # healthcare-specific income-statement items
            ...
            if balance is not None and col in balance.columns:
                ...
                # healthcare-specific balance-sheet items
            ...
            if cashflow is not None and col in cashflow.columns:
                ...
                # healthcare-specific cash-flow items
