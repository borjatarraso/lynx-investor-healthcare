...
class TestSectionExplanations:
    ...
    def test_health_quality_section_exists(self):
        sec = get_section_explanation("health_quality")
        assert sec is not None
        assert "Healthcare Quality" in sec["title"]
...
class TestConclusionMethodology:
    def test_overall_exists(self):
        ...
        assert "healthcare quality" in ce["description"].lower()
