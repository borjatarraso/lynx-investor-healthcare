...
from lynx_health.models import (
    ...
    HealthQualityIndicators, ShareStructure,
)
...
def explorer_report():
    ...
    r.health_quality = HealthQualityIndicators(quality_score=65.0,
...
class TestGenerateConclusion:
    ...
    def test_growth_has_stage_note(self, explorer_report):
        ...
        assert c.stage_note != ""
        assert "Growth" in c.stage_note or "Rule-of-40" in c.stage_note or "NRR" in c.stage_note
    ...
    def test_category_scores_present(self, explorer_report):
        ...
        assert "health_quality" in c.category_scores
