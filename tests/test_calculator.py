...
from lynx_health.metrics.calculator import (
    ...
    calc_efficiency, calc_share_structure, calc_health_quality,
...
class TestCalcShareStructure:
    def test_share_assessment(self, sample_info, sample_statements):
        ...
        # With 100M shares, healthcare-tier threshold classifies as "Standard"
...
class TestCalcHealthQuality:
    def test_quality_score_range(self, sample_info, sample_statements):
        ...
        m = calc_health_quality(p, g, s, ss, sample_statements, sample_info,
    ...
    def test_empty_inputs(self):
        m = calc_health_quality(ProfitabilityMetrics(), GrowthMetrics(), SolvencyMetrics(),
